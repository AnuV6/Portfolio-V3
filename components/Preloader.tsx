        ...
        <Fragment>
            ...
            >
                ...
                <div className="absolute inset-0 overflow-hidden" suppressHydrationWarning>
                    <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-primary/5 rounded-full blur-3xl animate-pulse" suppressHydrationWarning></div>
                    <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/3 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} suppressHydrationWarning></div>
                </div>

                <div className="relative flex flex-col items-center gap-8 z-10" suppressHydrationWarning>
                    {/* Main loader animation */}
                    <div className="relative w-32 h-32" suppressHydrationWarning>
                        {/* Outer glowing ring */}
                        <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary via-cyan-400 to-primary opacity-20 blur-xl animate-pulse" suppressHydrationWarning></div>
                        
                        {/* Rotating outer ring */}
                        <div className="absolute inset-0 border-[3px] border-transparent border-t-primary border-r-primary rounded-full animate-spin shadow-[0_0_25px_rgba(0,212,204,0.6)]" suppressHydrationWarning></div>
                        ...
                        <div className="absolute inset-6 bg-gradient-to-br from-primary/30 to-cyan-500/30 rounded-full animate-pulse shadow-[0_0_40px_rgba(0,212,204,0.4)]" suppressHydrationWarning></div>

                        {/* Center icon with glow */}
                        <div className="absolute inset-0 flex items-center justify-center" suppressHydrationWarning>
                            <div className="relative" suppressHydrationWarning>
                                <div className="absolute inset-0 blur-md bg-primary/50 rounded-full" suppressHydrationWarning></div>
                                <i className="fas fa-code text-white text-3xl relative z-10 animate-pulse"></i>
                            </div>
                        </div>

                        {/* Orbiting dots */}
                        <div className="absolute inset-0 animate-spin" style={{ animationDuration: '3s' }} suppressHydrationWarning>
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2 h-2 bg-primary rounded-full shadow-neon-cyan" suppressHydrationWarning></div>
                        </div>
                        <div className="absolute inset-0 animate-spin-reverse" style={{ animationDuration: '4s' }} suppressHydrationWarning>
                            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-2 bg-cyan-400 rounded-full shadow-neon-cyan" suppressHydrationWarning></div>
                        </div>
                    </div>

                    {/* Brand text with typing effect */}
                    <div className="flex flex-col items-center gap-4" suppressHydrationWarning>
                        <div className="text-3xl font-bold text-white tracking-wider" suppressHydrationWarning>
                        ...
                        <div className="flex items-center gap-3" suppressHydrationWarning>
                            ...
                            <div className="flex gap-1" suppressHydrationWarning>
                                <div className="w-1.5 h-1.5 bg-primary rounded-full animate-bounce shadow-neon-cyan" style={{ animationDelay: '0s' }} suppressHydrationWarning></div>
                                <div className="w-1.5 h-1.5 bg-primary rounded-full animate-bounce shadow-neon-cyan" style={{ animationDelay: '0.1s' }} suppressHydrationWarning></div>
                                <div className="w-1.5 h-1.5 bg-primary rounded-full animate-bounce shadow-neon-cyan" style={{ animationDelay: '0.2s' }} suppressHydrationWarning></div>
                            </div>
                        </div>
