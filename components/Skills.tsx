    ...
    return (
        <section className="row" aria-labelledby="soft-skills-heading">
            <div className="col-lg-12">
                {/* title */}
                <h2 id="soft-skills-heading" className="mb-6 relative flex items-end justify-between border-b border-white/10 pb-4 after:absolute after:bottom-[-1px] after:left-0 after:w-24 after:h-[2px] after:bg-primary after:shadow-neon-cyan">
...
const HardSkills = () => {
    return (
        <section className="row" aria-labelledby="hard-skills-heading">
            <div className="col-lg-12">
                {/* title */}
                <h2 id="hard-skills-heading" className="mb-6 relative flex items-end justify-between border-b border-white/10 pb-4 after:absolute after:bottom-[-1px] after:left-0 after:w-24 after:h-[2px] after:bg-primary after:shadow-neon-cyan">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className={`px-2 py-1 text-xs rounded font-medium ${
                                            skill.level === "Expert" ? "bg-secondary/20 text-secondary" :
