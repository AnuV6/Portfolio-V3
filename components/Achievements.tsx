    ...
    return (
        <section className="row" aria-labelledby="achievements-heading">
            <div className="col-lg-12">
                {/* title */}
                <h2 id="achievements-heading" className="mb-10 relative flex items-end justify-between border-b border-white/10 pb-4 after:absolute after:bottom-[-1px] after:left-0 after:w-24 after:h-[2px] after:bg-primary after:shadow-neon-cyan">
